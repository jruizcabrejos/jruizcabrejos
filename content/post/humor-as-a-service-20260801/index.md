...
date: "2026-08-01"
image:
  caption: 'A collection of 88x31 buttons, taken from [The 88x31 GIF Collection](https://cyber.dabamos.de/88x31/).'
...
Among these, the 88px wide by 31px high button standard (88x31) is one of the [most enduring formats](https://www.tekeye.uk/computer_history/powered-by).
...
<figure>
<img src="./gif.gif" alt="">
<figcaption>Figure 7.- Selection of buttons from Ky Decker button collection.</figcaption>
</figure>
...
"[You can't choose when it hits you](https://www.instagram.com/p/DMTcKewyjwL)"{{< pagenote "Taken from one of Michael Dumontier (b. 1974) and Neil Farber (b. 1975) artworks."/>}}, and one day, frustrated with [ggplot2](https://ggplot2.tidyverse.org/){{< pagenote "ggplot2 is a R package for declaratively creating graphics, based on The Grammar of Graphics."/>}}, for the first time since 2022, it hit me. The _big machine_ was finally able to give me a workaround for a piece of code I had spent hours struggling with that made me say:

> _~holy shit AI might actually take my job~_  oh, ok, that is cool.
{.thought-quote}

<figure>
<img src="./figure8_meme.png" alt="" style="width: 40%; height: auto;">
<figcaption>Figure 8. The original source of this meme might be lost to time.</figcaption>
</figure>
...
<figure>
<img src="./figure9_calvinandhobbesletsgoplayoutside.png" alt="" style="width: 70%; height: auto;">
<figcaption>Figure 9. I initially shared this Calving and Hobbes vignette in my personal Facebook on April 14, 2018.</figcaption>
</figure>
...
<figure>
<img src="./figure11_kristinmerrilees_meme.png" alt="" style="width: 70%; height: auto;">
<figcaption>Figure 11. Meme from internet culture writer <a href="https://www.phonetime.news/" target="_blank" rel="noopener noreferrer">Kristin Merrilees</a>.</figcaption>
</figure>
...
By coincidence, I finished writing it on August 1st, 2026, the [day of the World Wide Web](https://www.daysoftheyear.com/days/world-wide-web-day/).

<figure>
<img src="./figure12_guestbook_kydecker.jpg" alt="" style="width: 70%; height: auto;">
<figcaption>Figure 12. The message I left in Ky Decker's Guestbook on May 15th, 2026  .</figcaption>
</figure>
